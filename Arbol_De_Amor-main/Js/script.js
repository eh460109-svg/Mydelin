...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Holaa, espero que te guste este detalle, la verdad me hubiera gustado verte y decirte lo linda que eres y lo mucho me gustas`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con cariño, Ernesto";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-11-28T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-11-28T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Tiempo que llevamos conociendos: <b>${days}</b> días<br>` +
      `Ignora la cuenta regresiba no se puede quitar, tenia que poner algo si o si :)  : <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
